...
To delete all non-functional images (this deletes both non-functional BMC and non-functional host images):
...
Although, field mode is meant to be one way it can disabled by running the
