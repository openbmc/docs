...
* The UBI layout image is like `obmc-phosphor-image-<platform>.ubi.mtd.tar`
* The static layout image is like
...
When a BMC image is activated, each `image-<name>` is written to BMC chip's
