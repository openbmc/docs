...
To run clang-tidy checks, simply execute the command 'run-unit-test-docker.sh'.
This script will handle the setup and execution of clang-tidy within the Docker
container. For more details, refer to the
