...
file present in it's root directory, then CI will automatically verify the
python code meets the [pycodestyle](http://pycodestyle.pycqa.org/en/latest/intro.html)
