...
the global health. If any of the inventory of the chassis is in the
...
only tracks the equivalent of the global health state. It would be better to
have a consistent approach for all levels of the Redfish tree.
