...
of metric reports supported simultaneously. 
...
Such created metric report implements the
[`xyz.openbmc_project.Object.Delete`][10]
...
[`Report`][9] interface implements methods and properties for Reading Report
management along with properties containing telemetry readings. Each report
object contains the timestamp of its last update. The reading report object
