# OCP BIC Multi-host Platform specific OEM command Implementation
...
fb-ipmi-oem which has handler function for each standard oem command. Firmware
...
* exposing dbus interface to communicate with other modules (TBD)
...
firmware update and proposed name of the daemon is "ocp_bicd".
...
9) Ipmbbridged forwards the response the ocp-bicd daemon.
...
## Redfish Support
Existing Redfish DMTF standard (DSP2062_1.0.0) supports for firmware update of
