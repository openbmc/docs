...
| :------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-----------------------: | :-----------------------------------------------: |
| [xyz.openbmc_project.Cooling.Zone](https://gerrit.openbmc.org/c/openbmc/phosphor-dbus-interfaces/+/73151/2/yaml/xyz/openbmc_project/Cooling/Zone.interface.yaml)     |            New            |           Implement Leak Detector Zones           |
| [xyz.openbmc_project.Object.Enable](https://gerrit.openbmc.org/c/openbmc/phosphor-dbus-interfaces/+/73151/2/yaml/xyz/openbmc_project/Object/Enable.interface.yaml)   | Existing (with additions) |          Implement Leak Detector Status           |
| [xyz.openbmc_project.Inventory.Item](https://gerrit.openbmc.org/c/openbmc/phosphor-dbus-interfaces/+/73151/2/yaml/xyz/openbmc_project/Inventory/Item.interface.yaml) | Existing (with additions) | Implement inventory item related to Leak Detector |
...
```
           ...
           +----------|----------+
                      ...
                      v                                                                                   +--------------------------------------------------+
           +--------------------+       +------------------+             +---------------------+          |    Create Interface                              |
           |                    |       |                  |   creates   |                     |          |    xyz.openbmc_project.Cooling.Zone              |
           |    Config Parser   |------>|   Leak Manager   |------------>|    Cooling Zones    |--------->|    at                                            |
           |                    |       |                  |             |                     |          |    /xyz/openbmc_project/cooling/liquid/<ZoneX>   |
           +--------------------+       +------------------+             +---------------------+          |                                                  |
                                                                                    |                     +--------------------------------------------------+
                                                                                    |
                                                                                    v
...
The configuration specifies various cooling zones and their associated
detectors. Each zone is defined by the following properties:
...
A
[leak detection event](https://gerrit.openbmc.org/c/openbmc/phosphor-dbus-interfaces/+/73707)
interface is proposed, which will report leak detection events through Redfish
based on
