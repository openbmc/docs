...
normal error logs. This region will only be used if an overflow of the normal
error log queue is imminent, and will only contain up to 1 UE log which will not
be overwritten to preserve the original / first UE log already in the region.
