...
- The dm-verity parameters will be embedded in the FIT.
  ...
  kernel feature that is inserted at the end of the initramfs. This allows the
  parameters to be set during image assembly without having to patch the kernel
  nor the content of the initramfs.
