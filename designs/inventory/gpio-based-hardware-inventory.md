...
and then expose `xyz.openbmc_project.Configuration.GPIODeviceDetected` dbus
...
`xyz.openbmc_project.Configuration.GPIODeviceDetected` interface and
...
```json
{
  ...
  ...
  "Name": "My Fan Board 0",
  "Probe": "xyz.openbmc_project.Configuration.GPIODeviceDetected({'Name': 'fanboard0'})",
  "Type": "Board",
}
```
