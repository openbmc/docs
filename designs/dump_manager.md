...
## Problem Description
Duing a crash or a host failure an event monitor mechanism generates an error
log. But the size of the error log is limited to few kilobytes
...
![Dump usecases - Users are examples, not mandatory part of implementation](https://user-images.githubusercontent.com/16666879/70888651-d8f44080-2006-11ea-8596-ed4c321cfaa6.png)
