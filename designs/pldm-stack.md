...
set D-Bus interfaces below. The reason is that redfish schema didn't define state sensor
and thus we should update the reading directly on the inventory D-Bus object using 
this approach.
