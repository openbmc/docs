...
pldmd(PLDM daemon) utilizes the MCTP D-Bus interfaces defined at
...
also take the EID table from JSON file inputted by command line arguments for
the case of MCTP service(e.g. mctp-demux-daemon of libmctp) which does not
implement MCTP D-Bus interfaces.
