...
D-Bus object of its entity by an association. The sensor object implements
[xyz.openbmc_project.Association.Definitions](https://github.com/openbmc/phosphor-dbus-interfaces/blob/master/yaml/xyz/openbmc_project/Association/Definitions.interface.yaml)
...
inventory object is the endpoint of the association. This covers the entity
which the terminus itself represents and the entities whose type has no matching
