...
APIs for other services to lookup the mapping from EID to TID and vice versa.
After done that, 'pldmd' should send GetPLDMType and GetPLDMVersions commands
to the terminus to record what PLDM type message/version the terminus supports
in terminus table and provide APIs for other services to query. If there is any
