...
mechanisms. Google wants to extend the support to include REST based APIs.
...
```
This dbus daemon would need to run as root since the process owning RoT devices
are run as root.
