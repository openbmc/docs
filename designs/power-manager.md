...
- System Power Statistics: The timeframe in this mode is configurable. Each
  system only has 1 option for _System Power Statistics_ mode. The unit of
  timeframe in this option is milliseconds.
- Enhanced System Power Statistics: The timeframe in this mode is configurable.
  The system can have multiple options for _Enhanced System Power Statistics_
  mode. The unit of timeframe in this option can be seconds/minutes/hours/days.
...
- When the total power consumption exceeds the power limit affter waitting the
  specificed correction time, the `Power Management` application shall log an
