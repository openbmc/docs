...
standard in the [UEFI Specification](cper_spec), with CPU ISA specific
...
which is proposed to be added a future version of DMTF [DSP0248].
...
- An ARM CPU instance should be able to push CPER records into the BMC using one
  of the mechanisms defined in the [CPER specification](cper_spec).
...
more of the design referenced in this [CPER specification](cper_spec), for
...
[cper_spec]: https://developer.arm.com/documentation/den0069/latest/
[logentry]:
