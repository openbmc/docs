...
```ascii
 ...
 │                                │                               │
 │ ┌────────────────────────┐     │     ┌───────────────────────┐ │
 │ │  phosphor-pid-control  │     │     │  Diagnosis/Debugging  │ │
 │ └────────────────▲───────┘     │     └───────▲───────────────┘ │
 │                  │             │             │                 │
 │                  │dbus         │dbus         │dbus             │
 │                  │             │             │                 │
...
5. Other system daemons (private, not upstreamable) may need to configurate the
   ...
   access to the module and yield the raw i2c read/write access (or some APIs)
   to the diagnostic daemon or debugging CLI tools.
...
properties:
    - name: VendorOUI
      ...
      type: string
      description:
        A free form, implementation defined string which descirbe the module vendor
