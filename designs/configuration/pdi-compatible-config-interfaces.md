...
3. Reuse finite, well-defined interfaces across multiple records
4. Solution should scale to an arbitrary depth of information to be represented
5. Preserve backward compatibility with existing EM D-Bus layout.
6. Remain discoverable and human-browsable via D-Bus introspection tools.
7. Can be implemented over time, without heavy lifting
8. Support evolving and extending config schemas and DBus interfaces
9. Provide visible error reporting for unsupported schema depths.
...
%% comment
    ...
    GenClientThreshold["Generated Client for e.g. xyz.openbmc_project.Configuration.Threshold"];
...
| 3: property `a{sv}`       | y            | y             | n            | y              | 1                    | n         |
| 4. Typed Containers       | y            | y             | n            | y              | 2                    | y         |
| 5. Typed Containers 2     | y            | y             | n            | y              | 3                    | y         |
| 6. Hybrid                 | y            | n             | y            | n              | 3                    | y         |
| 7. Flat with Association  | y            | y             | y            | n              | 4                    | y         |
