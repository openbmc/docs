...
```
   ...
   | |                       |             |  +-----------------------+       +---------------------------+ ||
   | +-----------------------+             |  +-----------------------+       +---------------------------+ ||
   | |Get Attributes list    |<---Req-/Res--> | Call RBC dbus Method  |<-dbus-| GetAllAttributes()        | ||
   | |                       |             |  |                       |       |      -Attributeslist      | ||
