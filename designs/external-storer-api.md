...
Files created by ExternalStorer will all have the `.json` suffix, to reflect
their contents being JSON text. Directories created by ExternalStorer will have
no suffix.
...
49ae5069-3375-45b9-adfb-bc16c40ce0a6.json
index.json
```
...
$ cat /run/bmcweb/redfish/v1/Systems/system/LogServices/ExampleAlerts/Entries/49ae5069-3375-45b9-adfb-bc16c40ce0a6.json
