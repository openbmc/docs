...
```
{
    VMINetworkInterfaces: [
        {
            /ibm/v1/VMInterface/Network/<IntfId1>
        },
        {
            /ibm/v1/VMInterface/Network/<IntfId2>
        },
        ...
        ...
    ]
...
The below command gets the details of each interfaces.

Request:
```
curl -k -H "X-Auth-Token: $bmc_token" -X GET
https://${bmc}/ibm/v1/VMInterface/Network/<IntfId>
```
Response:
