...
- There should be a provision to release all the locks that are obtained by a
  particular session.
- There should be a provision to also release only specific locks based on the
  transaction ID
- There should be a provision to query to obtain list of all the locks that a
