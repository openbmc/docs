...
-H "X-Auth-Token: $bmc_token -X POST https://${bmc}/ibm/v1/VMInterface/network/<Id>/action/IP
-d ‘{“data”: ["xyz.openbmc_project.Network.IP.Protocol.IPv4", "address", "prefixlength", "gateway", "subnetmask"]}’
```
Response:
