...
2. ...uBootHWID
3. ...GXPFRU
   Reason: above interfaces do not reflect underlying hardware
5. ...BMCPrebootContext (not yet fully rejected)
   Reason: Arguably doesn't
   represent a hardware concept.
7. ...UbootDeviceModel
   Reason: There are ongoing efforts to enable dynamic
...
9. ...Platform
   Reason: Some attributes like serial-number or MAC don't apply
   across a given platform
11. ...Machine
   Reason: I like this one, but sounds a little vague to me. I've
