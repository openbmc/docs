...
secure element] [Edgelock-link] or [software providers] [software-prov-link]
like `default`, `fips`, `base`, `null`, [oqs-provider] [oqs-link] & also use the
providers as a secure certificate store by leveraging the exentensible [openssl
provider] [provider-link] API's, enhancing security, scalability, and
efficiency.
...
[nginx-ssl-engine]:
  http://nginx.org/en/docs/ngx_core_module.html#ssl_engine
[nginx-provider-api]:
  https://trac.nginx.org/nginx/ticket/2449
...
[tpm2-uri-debate]:
  https://github.com/tpm2-software/tpm2-openssl/issues/71
