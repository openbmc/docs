...
2. The callouts to capture the bmcweb events in the audit trail
...
using the Linux kernel audit subsystem. Adding a callout within
...
In order to record both types, the callout to record these events is done on
