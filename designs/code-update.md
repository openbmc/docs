...
executed before or after the update process. While these actions can be
integrated into the update process for some updaters, it is often ideal to
define them as structured hooks within the firmware update process. This section
aims to establish such hooks for applicable updaters.
