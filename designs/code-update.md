...
Please refer to
[current flow](https://github.com/jagpalgill/Code-Update/blob/main/Current-Design.md)
...
1. Able to schedule an update, given a firmware image and update settings.
...
https://github.com/jagpalgill/Code-Update/blob/main/Proposed-Design.md
...
changed to completely use the new API stack. No user-api impact as design
adheres to Redfish UpdateService.
...
Hardware vendor for \<deviceX>CodeUpdater may nominate a maintainer for this
code as it will be component specific.
...
- [phosphor-bmc-code-mgmt](https://github.com/openbmc/phosphor-bmc-code-mgmt)
- [openpower-pnor-code-mgmt](https://github.com/openbmc/openpower-pnor-code-mgmt)
- [pldm](https://github.com/openbmc/pldm/tree/master/fw-update)
- [phosphor-psu-code-mgmt](https://github.com/openbmc/phosphor-psu-code-mgmt)
