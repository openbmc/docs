...
These are GPIOs that can be used to enable or disable hardware from resetting
a BMC for specific conditions. Hardware may be able to be gated from doing a
BMC reset for these conditions as needed.
...
text does not need to be located at the beginning or the end of the name.
...
#### power-chassis0-standby-fault-unlatched, ...,
power-chassis\<N>-standby-fault-unlatched
