...
## Testing
The following BAT(basic acceptace test) has to be done
1. Install Lincese using Redfish API->varify the intallation
progress using Task tracket uri->varify success
2. Query installed license infor using redfish API
3. Try to install malformed license->varify the rejction 
status
