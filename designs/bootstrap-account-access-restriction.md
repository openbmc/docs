...
Quang Nguyen, Prithvi Pai (ppai@nvidia.com)
...
- A methodology allow the host retrieve BMC Ip address thru Ipmi commands
...
- The Redfish request is from `Redfish host interface`
...
### Host retrieve BMCIp thru Ipmi commands in EDK2
