...
priviledges. `usermod` does not support
[`openbmc_orfr_`](https://github.com/openbmc/docs/blob/master/designs/redfish-authorization.md#mapping-users-redfish-roles-and-redfish-privileges)
and `openbmc_rfr_` priviledges. Adding new priviledge type needs to be supported
by `usermod`.
