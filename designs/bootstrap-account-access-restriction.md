...
User -> User: Option "RHI-EnabledAfterReset" is True?\n+ Yes: "Enabled" property of CredentialBootstrapping Dbus Interface to True\n+ No : "Enabled" property is False
...
Web -> Web: Go to current BMC Web flow to authen and response Refish request
