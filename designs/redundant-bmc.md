...
- `FailoversPaused`
  - Indications a failover is not currently possible. Set when the system is in
    the middle of an operation like a power off.
...
| FailoversPaused   | Failovers paused   | State.Redundancy.BMC (RBMC App)        |

The YAML definition with more detail is [here][3].
...
- FailoversPaused: If the other BMC knows that failovers should be paused.
...
[3]: https://gerrit.openbmc.org/c/openbmc/phosphor-dbus-interfaces/+/73944
