...
system without actually having to scrape my system for the metric itself. For
...
binary as well as a shell script. Running an external program might have security concerns (in that the 3rd
