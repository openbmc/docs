...
- doEventHandling() - This method may have custom event handling
    routines for the respective button interface.
...
is dervied and stored as a dbus property with name "Position".
...
### OCP Debug card host selector buton dbus interface details :
  ...
  2. DebugCardPresent(property) - This property is a boolean which is based on
    the case if the debug card is connected or not.
