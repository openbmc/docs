# Debug Trigger: A software-driven debug data capture for critical BMC failures
...
### Analysis of BMC Error State Management and Mitigation Mechanisms
...
interface becoming unresponsive. Further, the more sever the reset type, the
...
The proposed design is for a simple daemon started at boot to invoke the
