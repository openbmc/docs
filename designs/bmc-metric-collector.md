...
It wouldnt make sense to clutter non-telemetry data inside their architecture.

### Referencing: phosphor-debug-collector

Phosphor-debug-collector was a daemon intended to collect log files and system
parameters. This is another exmaple of a daemon that scrapes information from
the BMC system and exposes this information. Any more additions that are not
debug logs would be overloading this daemon especially without a design for a
user of this daemon to reference.
