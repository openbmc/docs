...
| --------------------------------------------------------------- | ---------------- | ------------------------------------------------------------------------------------------ |
| Serving                                                         | AC & DC          | `D_total` = 0* <br/> `D_unmeasured` = 0* <br/> `D_user_down` = 0 <br/> `D_kernel_down` = 0 |
| Serving                                                         | AC               | `D_bmc_down` = 0                                                                           |
| Userspace shutdown                                              | AC & DC          | `D_user_down` = 0 <br/> `D_kernel_down` = 0                                                |
| Userspace shutdown                                              | AC               | `D_bmc_down` = 0                                                                           |
| BMC shutdown <br/> BMC                                          | AC               | `D_bmc_down` = 0                                                                           |
| BMC shutdown <br/> BMC                                          | DC               | Impossible scenario. Because the host is power off at this stage.                          |
