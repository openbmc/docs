...
+-------+--------+              +-------+--------+            +--------+--------+              +---------+-------+
 ...
 upload |image to 'HttPushUri'          |                              |                                 |
     by | POST                          |                              |                                 |
        ...
        |                               |                              |'HttpPushUriTargets' and sets the|
        |                               |                              | appropriate redundancy priority |
        |                               |                              | to the uploaded image object and|
        |                               |                              | calls 'fwupd' script with obj id|
        |                               |                              | as input to it.                 |
        |                               |                              |                                 |
        |                               |                              +-------------------------------->+
        |                               |                              |                                 | Script reads the 'RequestedActivation',
        |                               |                              |                                 | 'purpose' and redundancy priority of the
        |                               |                              |                                 | image using passed object id from
        |                               |                              |                                 | phosphor-software-manager objects
        |                               |                              |                                 | flash writes to appropriate targets
        |                               |                              |                                 | based on priority.
        |                               |                              |                                 |
        |                               |                              |                                 |
        +                               +                              +                                 +
...
set then the update service in BMC applies the image as to applicable firmware
target with redundancy priority as '0'.
