...
packets. The service will use poll lldpd to discover
neighbors that connected or disconnected from the BMC, and create or delete
neighbor objects accordingly.
