...
2. `xyz.openbmc_project.Network.LLDP.TLVs`
   ...
   - Properties:
     - `EnableLLDP` (bool): Enable or disable LLDP for the interface.
     - `ChassisId` (string)
...
These interface files are available in `https://gerrit.openbmc.org/c/openbmc/phosphor-dbus-interfaces/+/83533`:
