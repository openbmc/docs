...
support to actually activate, track, or enforce these timeout mechanisms. The
boot detection can also be used by other application that also need to be notify
in case of host booting.
