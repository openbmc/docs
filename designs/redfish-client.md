...
- Many properties with Redfish URIs have SMC-specific paths and are not fixed up
...
- Redfish paths, identifiers, and message-ids are specified by the SMC vendor,
  ...
  conventions. This in turn causes management systems to need to have
  SMC-specific design and code for particular server designs, requiring unique
  development and limiting system management convergence.
