...
- One example of SMC that supports Redfish protocol:
...
C++ classes from Redfish schemas. This is similar to DMTF
...
This tool would provide decent statically-typed class abstraction of the Redfish
data model for the Redfish client daemon so that direct validation and
...
objects are out of the scope of this tool but reside on the daemon side.
...
- Adopt
  [OpenBMC Http Library](https://gerrit.openbmc.org/c/openbmc/docs/+/67077) if
  it is being merged and implemented upstream
