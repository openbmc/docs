...
[refer](https://gerrit.openbmc.org/c/openbmc/entity-manager/+/80242). Below is
...
### Proposed Inventory items

These are some of the proposed items, and the design can be extended to include
new ones as required.

- [xyz.openbmc_project.Inventory.Item.ValveTrain](https://gerrit.openbmc.org/c/openbmc/phosphor-dbus-interfaces/+/77416)
  - For the corresponding Entity Manager Schema definition, please
    [refer](https://gerrit.openbmc.org/c/openbmc/entity-manager/+/77415).
- [xyz.openbmc_project.Inventory.Item.FlowMeter](https://gerrit.openbmc.org/c/openbmc/phosphor-dbus-interfaces/+/77417)
  - For the corresponding Entity Manager Schema definition, please
    [refer](https://gerrit.openbmc.org/c/openbmc/entity-manager/+/77350).
