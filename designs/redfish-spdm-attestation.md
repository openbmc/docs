...
- Enable the SPDM daemon to retrieve measurements & certificates from local TPM,
  expose them via D-Bus & Redfish interfaces and also use them for attestation.
...
- Get device certificates & measurements from local TPM and create D-Bus object.
