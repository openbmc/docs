...
should be represented as subordinate resources under TrustedComponent.
For the proper URI structure for certificates, please refer to the [Redfish Data
Model Specification][1].
Look for the CertificatesCollection row in the specification.
...
[1]: https://www.dmtf.org/sites/default/files/standards/documents/DSP0268_2024.4.html#resource-collection-uris-in-redfish-v16-and-later
