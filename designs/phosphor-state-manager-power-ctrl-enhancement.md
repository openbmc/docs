...
* chassis_system0 object for full power cycle of the entire system to be
...
2. Currently the chassis on/off is supported and it is proposed to add power
   cycle along with on/offunder phosphor-chassis-state-manager, it would be,
...
4. Add support for sled power cycle to control complete AC power cycle. The
...
to the other platforms. The sub-chassis power control feature configured from
