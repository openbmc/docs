...
2. Define Reboot Cause Type **WDIOF_EXTERN1**:

- The **WDIOF_EXTERN1** refers to the power-on reset.

3. Add Reboot Cause Type **WDIOF_EXTERN2**:

- This new type is added to categorize cases where a software reset occurs.

4. Revise the Definition of **WDIOF_CARDRESET**:
