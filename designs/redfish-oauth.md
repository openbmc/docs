...
issuer, audience, valid time, and most importantly, the scope, which specifies
the Redfish Roles or Redfish Privileges granted by the authorization server to
the client.
