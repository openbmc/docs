...
will add additional reviewers as appropriate.  The mechanism to add
reviewers is from that change's web page.

About maintainers.  Each repository is governed by a small group of
maintainer who are responsible leaders with expertise in that area
and are responsible for maintaining the quality of the code.
The criteria to become a maintainer are:
...
You are expected to address all comments, and do so in a positive way.
And remember to use the "reply" button to publish your replies for
others to see.
