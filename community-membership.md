...
| TOF member                                    | Set direction and priorities for the project           | Demonstrated responsibility and excellent technical judgement for the project                     | openbmc/openbmc [OWNERS] file _owners_ entry |
...
- **[Submit a CLA][contributor license agreement] to the openbmc mailing list**
  ...
  - Make sure that the list of contributions included is representative of your
    work on the project.
- Have your sponsoring CLA reviewers reply confirmation of sponsorship, who will
  add you to the relevant CLA group.
...
- Expected to be responsive to review requests as per [community expectations]
- Assigned changes to review related to the platform
...
- Nominated by two a subproject or root owners
...
may be more specific for individual subprojects.
