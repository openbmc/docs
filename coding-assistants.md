...
assistance when contributing to the OpenBMC.

AI tools helping with OpenBMC development should follow the standard kernel
...
requirements, and mut be compatible with the license of the repository in which
it is submitted.
...
When AI tools contribute to kernel development, proper attribution helps
