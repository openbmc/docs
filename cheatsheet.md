...
Use `oe-pkgdata-util` to inspect package ownership and file lists from Yocto package data. Run these commands after a successful build has completed and after your build environment/configuration has been set up (for example by
