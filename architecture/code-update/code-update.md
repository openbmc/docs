...
- Static Dual Image - Enables the code update process to support 2 copies of
the firmware image in a static layout. Enabled via the `static-dual-image`
...
[flash layout document]: https://github.com/openbmc/docs/blob/master/architecture/code-update/flash-layout.md
