...
- Method 1: From Redfish:
  A task is returned from the Redfish upload. The task can be used to monitor
  the progress.
...
- Method 1: From Redfish:
  Check the task returned from the Redfish upload.
...
- Method 1: From Redfish:
  If ApplyTime was set to "Immediate", the BMC will automatically reboot:
