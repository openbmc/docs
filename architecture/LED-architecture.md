...
Starting v2020.3, Redfish resources have **LocationIndicatorActive** property,
which is used to identify a particular resource. This is for LED Identify
operation only and must not be used to alter Fault indicators.
...
- bmcweb already has a dessign to look for `Functional` property and set the
  `Health` property.
