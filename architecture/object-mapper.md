...
```bash
busctl -j  call xyz.openbmc_project.ObjectMapper /xyz/openbmc_project/object_mapper xyz.openbmc_project.ObjectMapper GetPathsByAssociation oasasoasi / 1 "xyz.openbmc_project.Inventory.Item.Chassis" 2 "containing" "cooled_by" / 1 "xyz.openbmc_project.Inventory.Item.Fan" 0
```
