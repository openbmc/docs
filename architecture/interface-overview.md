...
It is intended to provide a reference suitable for a wide audience:
 ...
 - BMC administrators and system integrators learn about all of the primary
   interfaces system at a simplified level.  For example, to understand which
...
Unix domain socket named "obmc-console" which other OpenBMC services can use.
