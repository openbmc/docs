...
## Alternative yocto QEMU
  ...
  find be more stable. This is particually useful when debugging at the application level.
  ...
  ```
  - after that the all the a TAP network interface is added, and protocal like ssh, scp, http
  work well.
