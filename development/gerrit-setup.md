...
**Document Purpose:** Walkthrough setting up your development workflow to 
                      utilize Gerrit
...
* `git config --global --add user.email "youremail@some-domain"
    (eg. jsmith@somedomain.com)`
* `git config --global --add diff.tool "preferred diff tool"
    (eg. gvimdiff or meld)`
