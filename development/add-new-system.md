...
`conf` subdirectory. Within there you will see a layout like this:
...
3. Fetcher failure for URL: file://romulus.cfg
  ...
  romulus-prime to use the romulus.cfg file. We just need to add the `-prime` to
  the prepend path.
  ```
...
### Boot New System
  ...
  And you've finally built your new systems image! There are more customizations
