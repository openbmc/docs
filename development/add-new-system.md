...
- Install the led-group-config.json to /usr/share/phosphor-led-manager/
- Create a .bbappend file for phosphor-led-manager in the machine layer
  and put this line

- Put this line in that .bbappend file
EXTRA_OECONF += "--enable-use-json"

- Put the following line in .bbappend file if the configuration file
  is something different. For example:
LED_JSON_FILE ?= "/usr/share/lib/phosphor-led-manager/config.json"
