...
Workflow highlights:
  ...
  4. For OpenBMC problems:
    ...
    c. Negotiate how the code review will proceed.
        ...
        - Consider using [Patch set](https://en.wikipedia.org/wiki/Patch_(Unix)) emails
          to make reviews accessible to all stakeholders.
...
OpenBMC Security Advisory (include the id and title).
Summary: include CVEs if available
Releases affected: release IDs, or commit-ids where the problem was
introduced
Description: ...
