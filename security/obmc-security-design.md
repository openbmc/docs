...
The level of detail in this document is inconsistent.  See the Common
Criteria standard, Part 3, "Evaluation Assurance Levels" (EAL) for
more information about the benefits of documenting OpenBMC's design.
The Common Criteria documentation suggests that a development team
using "sound development practises" can achieve EAL3.
...
release life-cycle when they ddon't have full control of integrations
into the code?
