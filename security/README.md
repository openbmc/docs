...
OpenBMC team leadership:
 ...
 - Team-wide security requirements.
   These are addressed in the obmc-security-framework.  Examples:
    - coding conventions reduce coding errors and
      make it easier to understand code,
    - code reviews make it easier to discover security flaws,
    - source code control provides a way to ensure that only reviewed
      and approved code goes into the project, and
...
1. Complete the framework.  The framework consists of three main pieces:
   ...
   For each section:
    ...
    2. Motivate and establish relevance, by quoting a sentence from
       the Common Criteria books.
    3. Begin to fill in details (see phase 2).
...
2. Fill in the framework with details about OpenBMC.  This documents
   ...
   provided as needed (see phase 3).
