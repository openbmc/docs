...
with the and specifically the
[Common Criteria for Information Technology Security Evaluation]
(https://www.commoncriteriaportal.org/cc)
publications, parts 1-3.
...
- [Part 2: Security assurance requirements]
  (https://www.commoncriteriaportal.org/files/ccfiles/CCPART3V3.1R5.pdf)
In this document, references to the CC are like this: (ASE_INT).
...
you'll need to know these commonly-used acronyms (defined in CC Part 1):
...
### Target of Evaluation (CC part 1:TOE)
...
Specifically, it addresses the following (CC Part 1) topics:
...
The Evaluation Assurance Level (EAL) expresses
...
security evaluations at assurance level 4 (CC part 3:EAL4).
This level requires:
...
The OpenBMC project addresses the following major assurance areas:
 ...
 - ALC_TAT tools and techniques
   This addresses things like C++ coding standards,
 ...
 - AVA_VAN - vulnerability analysis
   Note that the results of any vulnerability analysis are
   not necessarily made publicly available because
   we don't want to help attackers.
   The core team publishes the results in the form of work items.
