...
See the details on authenticaton at
https://github.com/openbmc/docs/blob/master/REST-cheatsheet.md

This tutorial uses basic authenticaton URL encoding, so just pass in the user
name and password as part of the URL and no separate login/logout commands
are required:
