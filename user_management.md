...
## phosphor-user-manager - overview
...
```
          ...
          |    | AccountUnlockDTimeout, RememberOldPassword  |      |
          |    +---------------------------------------------+      |
          |                                                         |
          |        Remote User Management - Configuration           |
          |    +--------------------------+------------------+      |
          |    |  Provides interface to configure any        |      |
          |    |  remote user management configuration       |      |
          |    |  (LDAP / NIS / KRB5)                        |      |
          |    +---------------------------------------------+      |
          |                                                         |
...
Stacked PAM modules allow all 'ipmi' group users password to be stored
