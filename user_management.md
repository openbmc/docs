...
|5     | REDFISH | Users in this group are only allowed to use REDFISH Interface. Privilege of the user has to be determined and maintained by IPMI itself |
...
same can be implemented through OEM Commands, there-by creating a user in
